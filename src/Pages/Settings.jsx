    ...
    <div className="flex flex-col">
      ...
      <div className="mt-[10vh] overflow-auto flex flex-col ml-[22vw] md:ml-[22vw] lg:ml-[22vw] xl:ml-[22vw] home-section h-auto">
        <div className="p-4 flex flex-col h-full gap-4">
            ...
            <div className="flex flex-row w-full">
              <div className="flex flex-row gap-4 basis-[33%]">
                ...
                <div className="flex flex-col justify-center items-start">
                  <p className="graphik-font font-[500] max-h-900:text-[1.1rem] text-[1.4rem]">
                    Company name:
                  </p>
          ...
          <div className="border-[1px] flex-1 flex flex-col rounded-md border-[#000000] p-4 max-h-900:gap-2 gap-4">
            <div className="flex flex-col">
            ...
            <div className="border-[#7B7B7B] border-[1px] rounded-md flex gap-6 items-center flex-row px-4 py-5">
              ...
              <div className="basis-[90%] flex flex-col gap-1">
                <div className="flex flex-row justify-start font-[400] items-center gap-4">
                  <p className="graphik-font max-h-900:text-[1.2rem] text-[1.4rem]">
                    Authenticator App
                  </p>
            ...
            {!data?.is_2fa_setup_done && data && (
              <>
                ...
                <div className="w-full flex flex-col justify-between">
                  ...
                  <div className="w-full border-t-[1px] block border-[#7B7B7B] mt-6 h-[0px]"></div>{" "}
                </div>
