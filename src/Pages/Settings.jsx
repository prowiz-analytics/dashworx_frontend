            ...
            <div className="flex flex-col gap-4 w-full ml-[10%]">
              ...
              <div className="flex flex-col justify-start items-start gap-4 w-full">
                ...
                <div className="flex flex-row justify-center items-center gap-4 cursor-pointer">
                  ...
                  <Link to={"/settings"}>
                    <p className="font-[500] text-[1.8vmin] graphik-font text-[#28262C] border-[#000000] border-b-[1px] ">
                      Settings
                    </p>
                  </Link>
                </div>
            ...
            <div className="flex flex-row w-full">
              ...
              <div className="flex flex-row gap-4 basis-[30%] justify-center items-center">
                <div className="flex flex-col justify-center items-start">
                  ...
                  <p className="quicksand-font text-[1.2rem]">{data?.email}</p>
                </div>
              </div>
              <div className="flex flex-row gap-4 basis-[30%] items-center justify-center">
                <div className="flex flex-col justify-center items-start">
                  ...
                  <p className="quicksand-font text-[1.2rem] underline" onClick={()=>navigate('/resetpassword')}>
                    Change Password ?
                  </p>
                </div>
              </div>
              ...
              <div className="basis-[90%] flex flex-col gap-1">
                <div className="flex flex-row justify-start items-center gap-4">
                  ...
                  {(data && !data?.is_2fa_enabled) && (
                    <span className="px-5 py-1 bg-[#274156] text-[#ffffff] text-[0.9rem] rounded-[20px]">
                      Not enabled
                    </span>
                  )}
                  {(data && data?.is_2fa_enabled && data?.is_2fa_setup_done) && (
                    <span className="px-5 py-1 bg-[#2F6A41] text-[#ffffff] text-[0.9rem] rounded-[20px]">
                      Activated
                    </span>
                  )}
                  {(data && data.is_2fa_enabled && !data?.is_2fa_setup_done) && (
                    <span className="px-5 py-1 bg-[#A51E2C] text-[#ffffff] text-[0.9rem] rounded-[20px]">
                ...
                <div className="w-full flex flex-row justify-between">
                  <div className="">
                    ...
                    <input
                      ...
                      className={`${"focus:border-[black] no_outline"} ${
                        invalidOtp ? "border-[red]" : "border-black"
                      } text-[1rem] w-[100%] focus:outline-none max-h-900:px-2 max-h-990:py-3 px-3 py-3 rounded-md`}
                    />
                  </div>
                  <div className="flex flex-col justify-end">
                    <button
                      ...
                      }  px-8 py-2 text-[#ffffff] text-[1.2rem] font-[500] rounded-[10px]`}
                      onClick={setup_2fa}
                    >
                      Turn on
                    </button>
