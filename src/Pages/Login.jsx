    ...
    <div className="w-[100vw] h-[100vh] bg-[#D9D9D9] flex flex-col justify-around items-center">
      ...
      {is2faPage && (
        <div className="flex flex-col gap-4 h-[55vh] mb-[15vh] justify-center items-center">
          ...
          <div className="rounded-[10px] bg-[#ffffff] max-h-600:h-[auto] h-[55vh] w-[35vw] sm:w-[27vw] md:w-[32vw] 2xl:w-[30vw] quicksand-font flex flex-col max-h-600:py-4 2xl:px-12  px-4 py-4">
            <p className="max-h-600:text-[1.25rem] mb-[0px] graphik-font text-[2rem] font-[500]">
              Check your authentication app
            </p>
            <p className="max-h-600:text-[0.75rem] text-[1.2rem]">
            ...
            >
              ...
              <input
                type="submit"
                value="Login"
                className={`w-[100%] bg-[#7d8d9a] max-h-600:text-[0.75rem] text-[1.1rem] items-center max-h-900:px-2 max-h-900:py-4 px-4 py-4 p-4 text-[#ffffff] font-bold rounded-[10px] cursor-pointer`}
              />
              <div className="flex justify-end items-end  ">
                <p to={"/settings"} className="underline cursor-pointer" onClick={reset_2fa}>
